...
if(isset($_GET['success'])) {
  echo '<div class="alert alert-dismissible alert-success">
    <strong>Compleato!</strong> el producto ha sido creado.
  </div>';
}
...
?>
       <form  method="post" action="?view=productos&mode=add" class="formulario" enctype="multipart/form-data" enctype="application/x-www-form-urlencoded">
